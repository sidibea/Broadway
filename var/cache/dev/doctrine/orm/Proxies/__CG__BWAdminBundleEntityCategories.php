 ...
 */
class Categories extends \BW\AdminBundle\Entity\Categories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BW\\AdminBundle\\Entity\\Categories' . "\0" . 'id', '' . "\0" . 'BW\\AdminBundle\\Entity\\Categories' . "\0" . 'name', '' . "\0" . 'BW\\AdminBundle\\Entity\\Categories' . "\0" . 'description', '' . "\0" . 'BW\\AdminBundle\\Entity\\Categories' . "\0" . 'image', '' . "\0" . 'BW\\AdminBundle\\Entity\\Categories' . "\0" . 'dateAdd', '' . "\0" . 'BW\\AdminBundle\\Entity\\Categories' . "\0" . 'dateUpd', '' . "\0" . 'BW\\AdminBundle\\Entity\\Categories' . "\0" . 'enabled'];
        }
